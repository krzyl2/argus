...
updated: 2026-07-08T11:53:17Z
---

## Current Test

number: 1
name: Visual/theme parity across both themes
expected: |
  All three screens (#/dashboard, #/algorithms, #/settings) visually match the Argus
  Design System in both light and dark themes (spacing, contrast, token usage); theme
  changes propagate live and instantly between the Sidebar toggle and the Settings
  Appearance control.
